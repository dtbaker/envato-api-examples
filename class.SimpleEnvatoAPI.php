...
class SimpleEnvatoAPI {
	...
	public function api( $endpoint, $params = array(), $personal = true ) {
		...
		if( $this->_mode == 'personal' ){
			if(empty($this->_personal_token) || $this->_personal_token == '___PASTE_TOKEN_HERE___'){
				die('Please set a valid personal token in the config.php file');
			}
		}
